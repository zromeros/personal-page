...
export function SiteHeader({
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[var(--header-bg)] backdrop-blur-md">
      <div className="mx-auto flex max-w-[1440px] flex-wrap items-center justify-between gap-4 px-8 py-5 text-left max-lg:px-5 max-lg:py-4">
        <span className="font-[family-name:var(--heading)] font-semibold text-[var(--text-h)] tracking-tight">
          {brand}
        </span>
